...
#if DEBUG_BUILD
#define FW_VERSION_STR "V4.3.6_DBG"
#define CFG_DEFAULT_R_SERIES_MOHM   HW_SERIES_R_MOHM
#elif DEBUG_LP_BUILD
#define FW_VERSION_STR "V4.3.6_DBGL"
#define CFG_DEFAULT_R_SERIES_MOHM   HW_SERIES_R_MOHM
#elif POWER_SAVE_BUILD
#if POWER_SOURCE_DIRECT
#define FW_VERSION_STR "V4.3.6_ECO_D"
#define CFG_DEFAULT_R_SERIES_MOHM   HW_SERIES_R_MOHM
#else
#define FW_VERSION_STR "V4.3.6_ECO_B"
#define CFG_DEFAULT_R_SERIES_MOHM   (HW_SERIES_R_MOHM + 2 * BATT_SR516SW_SINGLE_R_MOHM)
#endif
#else
#if POWER_SOURCE_DIRECT
#define FW_VERSION_STR "V4.3.6_DIRECT"
#define CFG_DEFAULT_R_SERIES_MOHM   HW_SERIES_R_MOHM
#else
#define FW_VERSION_STR "V4.3.6_BATT"
#define CFG_DEFAULT_R_SERIES_MOHM   (HW_SERIES_R_MOHM + 2 * BATT_SR516SW_SINGLE_R_MOHM)
#endif
#endif
